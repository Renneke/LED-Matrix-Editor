...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AddWordDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 37, 21)
    ...
    "AddWordDialog\0on_buttonBox_accepted\0"
...
const QMetaObject AddWordDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddWordDialog.data,
      qt_meta_data_AddWordDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddWordDialog.stringdata))
